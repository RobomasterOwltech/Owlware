...
fp32 BMI088_GYRO_SEN = BMI088_GYRO_2000_SEN;
    ...
    //#define BMI088_accel_write_muli_reg( reg,  data, len) { BMI088_ACCEL_NS_L(); BMI088_write_muli_reg(reg, data,
    //len); BMI088_ACCEL_NS_H(); }
    ...
    //#define BMI088_gyro_write_muli_reg( reg,  data, len) { BMI088_GYRO_NS_L(); BMI088_write_muli_reg( ( reg ), ( data
    //), ( len ) ); BMI088_GYRO_NS_H(); }
