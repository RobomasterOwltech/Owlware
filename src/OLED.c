...
void OLED_init(void) {
    ...
    oled_write_byte(0x00, OLED_CMD);  // 00,Horizontal Addressing Mode;01,Vertical Addressing Mode;10,Page Addressing
...
bool_t OLED_check_ack(void) { return bsp_I2C_check_ack(OLED_I2C, OLED_I2C_ADDRESS); }
