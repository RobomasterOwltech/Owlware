...
void ist8310_delay_ms(uint16_t ms) { osDelay(ms); }
void ist8310_delay_us(uint16_t us) { delay_us(us); }

void ist8310_RST_H(void) { HAL_GPIO_WritePin(RSTN_IST8310_GPIO_Port, RSTN_IST8310_Pin, GPIO_PIN_SET); }
extern void ist8310_RST_L(void) { HAL_GPIO_WritePin(RSTN_IST8310_GPIO_Port, RSTN_IST8310_Pin, GPIO_PIN_RESET); }
